        ...
        <CardContent className="p-6 space-y-8 text-sm leading-relaxed">
          ...
          <section className="space-y-2">
            ...
            <ul className="list-disc list-inside space-y-1 text-muted-foreground pl-2">
              <li>
                Community forum for technical discussions, questions, and
                showcases.
              </li>
              <li>Code snippet sharing and collaboration tools.</li>
              <li>
                Coding challenges, duels, and contests with a ranking system.
              </li>
              <li>
                Developer tools (JSON formatter, regex tester, UUID generator,
                etc.).
              </li>
              <li>
                Gamification features including XP, levels, achievements, and
                leaderboards.
              </li>
          ...
          <section className="space-y-2">
            ...
            <ul className="list-disc list-inside space-y-1 text-muted-foreground pl-2">
              ...
              <li>
                ...
                <a
                  href="mailto:support@commitcamp.com"
          ...
          <section className="space-y-2">
            ...
            <p className="text-muted-foreground">
              You agree to use CommitCamp only for lawful purposes. You must
              not:
            </p>
            <ul className="list-disc list-inside space-y-1 text-muted-foreground pl-2">
              <li>
              ...
              <li>
                Share malicious code, malware, or content designed to harm
                systems or users.
              </li>
              <li>
                Spam, flood, or repeatedly post the same or similar content.
              </li>
              <li>
                Impersonate other users, employees, or public figures.
              </li>
              <li>
              ...
              <li>
                Scrape, crawl, or extract platform data in bulk without written
                permission.
              </li>
              <li>
                Artificially manipulate XP, rankings, or achievement systems.
              </li>
              <li>
          ...
          <section className="space-y-2">
            ...
            <p className="text-muted-foreground">
              You retain ownership of the content you create and post on
              CommitCamp (forum posts, snippets, comments). By posting content,
              you grant CommitCamp a non-exclusive, royalty-free, worldwide
              license to display, store, and distribute that content as part of
              the Service.
            </p>
            <p className="text-muted-foreground">
            ...
            <p className="text-muted-foreground">
              ...
              terms or that we determine, at our sole discretion, is harmful to
              the community.
            </p>
          </section>
          ...
          <section className="space-y-2">
            ...
            <p className="text-muted-foreground">
              The CommitCamp name, logo, design, and all platform-specific
              content (developer tools, UI, challenge content created by our
              team) are the intellectual property of CommitCamp and are
          ...
          <section className="space-y-2">
            ...
            <p className="text-muted-foreground">
              CommitCamp integrates with third-party services including GitHub,
              Google, Discord, and AI providers. Your use of these integrations
              is subject to the respective providers&apos; terms of service. We are
              not responsible for the availability or actions of third-party
              services.
            </p>
          </section>
          ...
          <section className="space-y-2">
            ...
            <p className="text-muted-foreground">
              ...
              free of harmful components. We make no guarantee regarding the
              accuracy of AI-generated content from the AI Assistant feature.
            </p>
          </section>
          ...
          <section className="space-y-2">
            ...
            <p className="text-muted-foreground">
              To the maximum extent permitted by law, CommitCamp and its
              operators shall not be liable for any indirect, incidental,
              special, consequential, or punitive damages arising from your use
              of or inability to use the Service, including but not limited to
              loss of data, loss of profits, or damage to reputation.
            </p>
          </section>
          ...
          <section className="space-y-2">
            ...
            <p className="text-muted-foreground">
              ...
              discretion for violations of these Terms. Upon termination, your
              right to access the Service ceases immediately. Some content you
              have contributed to the community may be retained in anonymized
              form.
            </p>
          </section>
          ...
          <section className="space-y-2">
            ...
            <p className="text-muted-foreground">
              ...
              sending an email. Continued use of CommitCamp after changes take
          ...
          <section className="space-y-2">
            ...
            <p className="text-muted-foreground">
              ...
              use of CommitCamp shall be resolved through good-faith
