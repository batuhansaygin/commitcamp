        ...
        <CardContent className="p-6 space-y-8 text-sm leading-relaxed">
          ...
          <section className="space-y-2">
            ...
            <ul className="list-disc list-inside space-y-1 text-muted-foreground pl-2">
              ...
              <li>
                ...
                pages visited, features used, and interactions within the
                platform.
              </li>
              <li>
          ...
          <section className="space-y-2">
            ...
            <ul className="list-disc list-inside space-y-1 text-muted-foreground pl-2">
              ...
              <li>
                Personalize your experience (feed, recommendations,
                achievements).
              </li>
              <li>
                Enable community features such as following other users,
                reactions, and leaderboards.
              </li>
              <li>
                Send you important service notifications (password resets,
                security alerts).
              </li>
              <li>
                Calculate XP, levels, streaks, and badges for the gamification
                system.
              </li>
              <li>
                Analyze platform usage in aggregate to improve the product.
              </li>
            </ul>
            <p className="text-muted-foreground">
          ...
          <section className="space-y-2">
            ...
            <ul className="list-disc list-inside space-y-1 text-muted-foreground pl-2">
              <li>
                ...
                authentication, and file storage. Your data is stored on
                Supabase&apos;s infrastructure.
              </li>
              <li>
                <strong className="text-foreground">GitHub OAuth</strong> — for
                sign-in. We receive your public GitHub profile (username, email,
                avatar).
              </li>
              <li>
                <strong className="text-foreground">Google OAuth</strong> — for
                sign-in. We receive your public Google profile (name, email,
                avatar).
              </li>
              <li>
                <strong className="text-foreground">Discord OAuth</strong> — for
                sign-in and optional Discord messaging integration.
              </li>
              <li>
              ...
              <li>
                <strong className="text-foreground">Google Gemini / Groq</strong>{" "}
                — for the AI Assistant feature. Messages sent to the AI
                assistant may be processed by these providers. We do not store
                AI chat history.
              </li>
            </ul>
          </section>
          ...
          <section className="space-y-2">
            ...
            <p className="text-muted-foreground">
              ...
              it for legal or security reasons. Content you have posted (forum
              posts, snippets, comments) may be anonymized rather than deleted
              to preserve the integrity of community discussions.
            </p>
          </section>
          ...
          <section className="space-y-2">
            ...
            <p className="text-muted-foreground">
              ...
              (managed by Supabase). We do not use advertising cookies or
              third-party tracking cookies. You may disable cookies in your
              browser, but this will prevent you from logging in.
            </p>
          </section>
          ...
          <section className="space-y-2">
            ...
            <p className="text-muted-foreground">
              ...
              data, including encrypted connections (HTTPS/TLS), Row Level
              Security (RLS) on all database tables, and hashed passwords. We
              never store your OAuth provider passwords. However, no method of
          ...
          <section className="space-y-2">
            ...
            <p className="text-muted-foreground">
              ...
              <a
                href="mailto:privacy@commitcamp.com"
          ...
          <section className="space-y-2">
            ...
            <p className="text-muted-foreground">
              CommitCamp is not directed to children under the age of 13. We do
          ...
          <section className="space-y-2">
            ...
            <p className="text-muted-foreground">
              ...
              CommitCamp after changes constitutes acceptance of the updated
              policy.
            </p>
          </section>
